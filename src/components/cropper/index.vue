    ...
    <div class="right-con">
      ...
      <div class="button-box">
        ...
        <div v-show="insideSrc">
          ...
          <Button style="width: 150px;margin-top: 10px;" type="primary" @click="crop" :loading="ext.uploadLoading">{{ cropButtonText }}</Button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    crop () {
      let fileType = ''
      if (this.insideSrc) {
        fileType = this.insideSrc.match(/data:(\S*);base64,/) ? this.insideSrc.match(/data:(\S*);base64,/)[1] : ''
      }
